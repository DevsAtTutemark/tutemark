...
var DPWorkBench_ResponsiveWidget = new Class({
  ...
  toggleVersion: function(pSize, pCheck, pShouldICopyElements) {
    ...
    if(!pCheck) {
      this.mToolbar.destroy();
      DSWindow.CreateConfirm('Are you sure you want to delete '+ pSize.text +'? <br/><br/>Please note that the '+ pSize.text +' <strong>breakpoint will be removed from all pages in this wireframe</strong> and that you will not be able to undo this action.<br /><br />', 'Delete '+ pSize.text +'? ', transtext('Yes'), transtext('No'), function() {
...
;(function Preview_Elements_Multistate_Scope() {
  ...
  var Preview_Elements_Multistate = new Class({
    ...
    initialize: function(pEl, pOptions, pProperties) {
      ...
      Array.prototype.forEach.call(this.mEl.querySelectorAll('.state'), function(pStateEl) {
        var state = {
